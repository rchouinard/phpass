...
use PHPassLib\Hash\Adapter\Bcrypt;
...
class Hash
{
     ...
     *     $options = array (
     *         'adapter' => new \PHPassLib\Hash\Adapter\ExtDes,
     *         'hmacKey' => 'mys3cr3tk3y'
     *     );
     *     $phpassHash = new \PHPassLib\Hash($options);
     *
    ...
    public function __construct($options = array ())
    {
        ...
        if (!is_array($options)) {
            throw new InvalidArgumentException('Expected an instance of PHPassLib\\Hash\\Adapter or an associative array of options.');
        }
            ...
            switch ($option) {
                case 'adapter':
                    if (!$value instanceof Adapter) {
                        throw new InvalidArgumentException("Value of key 'adapter' must be an instance of PHPassLib\\Hash\\Adapter.");
                    }
